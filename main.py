            ...
            while True:
                ...
                for current_account in roblox_accounts:
                    ...
                    if current_account.config.debug["ignore_limit"] == False:
                        ...
                        if self.json.check_ratelimit_cookie(
                    ...
                    if not current_account.account_inventory:
                        log(f"{current_account.username} has no tradeable inventory")
                        ...
                        if send_trade_response:
                            ...
                            embed_fields, total_profit = (
                                self.discord_webhook.embed_fields_from_trade(
                                    generated_trade,
                                    self.rolimons.item_data,
                                    self.rolimons.projected_json.read_data(),
                                )
                            )
